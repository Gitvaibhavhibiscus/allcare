   ...
   <div class="head_banner col-12 p-0">
      ...
      <div class="bottom_card">
         <div class="bg_circle">
            ...
            <h1 class="m-0 text-white font-primary">Clearwater</h1>
         </div>
      </div>
   </div>
      ...
      <div class="container mt-5 mb-5">
         <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12 pr-lg-5 mb-4">
               ...
               <h3 class="location-det mb-3">1745 S. Highland Avenue, Clearwater, FL 33756</h3>
               <h4 class="location-add">Phone:</h4>
               <h3 class="location-det mb-3">727-587-0377</h3>
               <h4 class="location-add">Fax:</h4>
               <h3 class="location-det mb-3">727-587-0527</h3>
               <div class="row mt-4">
                  <div class="col-lg-12 col-md-12 col-sm-12">
                     <a href="#clearwater" class="btn btn-primary w-100" target="_blank">Schedule an appointment </a>
                  </div>
               </div>
            </div>
            <div class="patient-listing col-lg-6 col-md-6 col-sm-12 px-2 pl-lg-5">
               <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d7049.917878598037!2d-82.774699!3d27.933904!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x88c2f07cd1d54519%3A0x96423451d9a1a792!2s1745%20S%20Highland%20Ave%2C%20Clearwater%2C%20FL%2033756%2C%20USA!5e0!3m2!1sen!2sin!4v1696330335100!5m2!1sen!2sin" width="100%" height="350" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </div>
         </div>
      </div>
   </div>
</div>
<div id="clearwater-provider" class="container-fluid p-0 bg_illustration">
   <div class="container mt-5 mb-5">
      <h3>Our Team at Clearwater</h3>
...
<div class="container-fluid p-0">
   <div id="clearwater" class="container mt-5 mb-5">
