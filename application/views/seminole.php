   ...
   <div class="head_banner col-12 p-0">
      ...
      <div class="bottom_card">
         <div class="bg_circle">
            ...
            <h1 class="m-0 text-white font-primary">Seminole</h1>
         </div>
      </div>
   </div>
      ...
      <div class="container mt-5 mb-5">
         <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12 pr-lg-5 mb-4">
               ...
               <h3 class="location-det mb-3">8900 Park Blvd N., Seminole, FL 33777</h3>
               <h4 class="location-add">Time:</h4>
               <h3 class="location-det mb-3"> 8am – 5pm</h3>
               <h4 class="location-add">Phone:</h4>
               <h3 class="location-det mb-3">727-545-4545</h3>
               <h4 class="location-add">Fax:</h4>
               <h3 class="location-det mb-3">727-548-1360</h3>
               <div class="row mt-4">
            ...
            <div class="patient-listing col-lg-6 col-md-6 col-sm-12 px-2 pl-lg-5">
               <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d14112.196450969313!2d-82.762391!3d27.839026!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x88c2fb65c2ec37bf%3A0xec80b25737afb551!2s8900%20Park%20Blvd%2C%20Seminole%2C%20FL%2033777!5e0!3m2!1sen!2sus!4v1696331145427!5m2!1sen!2sus" width="100%" height="350" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </div>
         </div>
      </div>
   </div>
</div>
<div id="seminole-provider" class="container-fluid p-0 bg_illustration">
   <div class="container mt-5 mb-5">
      <h3>Our Team at Seminole</h3>
      <?php include 'partial/provider_tab_seminole.php'; ?>
   </div>
</div>
