...
function sesmail($to, $subject, $message) {
    ...
    public function appointment_form(){
        ...
        $post_data = $this->input->post(["full_name","phone_number","email_address","date","office","reason"], TRUE);
        $post_data["created_at"] = date('Y-m-d H:i:s');
        $post_data["_server"] = json_encode($_SERVER);
        ...
        $email_message = '
        Hi,<br/>
        Received a new appointment request from '.$post_data['full_name'].'.<br/><br/>
        <table cellspacing="0" cellpadding="5" border="1">';
